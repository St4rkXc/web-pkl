...
function tabs(button, secbutton, thirdbutton, content) {
    ...
    secbutton.classList.add("border-b-primary/30");
    thirdbutton.classList.add("border-b-primary/30");
...
button2.addEventListener("click", () => tabs(button2, button1, button2, content2));
button3.addEventListener("click", () => tabs(button3, button2, button3, content3));
